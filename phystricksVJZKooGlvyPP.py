...
def VJZKooGlvyPP():
    ...
    pspict.axes.single_axeX.put_mark(0.2,-45,"\SI{c}{\centi\meter} ",automatic_place=(pspict,"corner"))
    pspict.axes.single_axeY.put_mark(0.2,-45,"\( p\)(\si{\centi\meter})",automatic_place=(pspict,"corner"))
