...
%TODO : ... surtout que ce sont des rappels du collège, donc il ne faut pas en mettre explicitement
%       c'est par contre pas mal que les propriétés de triangles et de parallélogrammes arrivent de temps en temps 
%       dans d'autres occasions.
% Bref : il faut un peu revoir tout ça.
\Exo{Seconde-0045}
\Exo{smath-0010}
