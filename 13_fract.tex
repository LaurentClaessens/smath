...
\begin{example}
    ...
    \begin{equation}
   \input{Fig_PATooDkWFPDO.pstricks}
   =
   \input{Fig_PATooDkWFPDZ.pstricks}
    \end{equation}
\end{example}
...
\begin{example}
    ...
    \begin{equation}
        3\times \input{Fig_GLVooUSQccDZ.pstricks}=\input{Fig_GLVooUSQccDZ.pstricks}+\input{Fig_GLVooUSQccDZ.pstricks}+\input{Fig_GLVooUSQccDZ.pstricks}=\input{Fig_GLVooUSQccDO.pstricks}+\input{Fig_GLVooUSQccDZ.pstricks}.
    \end{equation}
