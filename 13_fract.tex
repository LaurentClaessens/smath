...
\begin{example}
    ...
    \begin{equation}
        3\times \input{Fig_GLVooUSQccD0.pstricks}=\input{Fig_GLVooUSQccD0.pstricks}+\input{Fig_GLVooUSQccD0.pstricks}+\input{Fig_GLVooUSQccD0.pstricks}=\input{Fig_GLVooUSQccD1.pstricks}+\input{Fig_GLVooUSQccD0.pstricks}.
    \end{equation}
