...
\begin{example}
    ...
    \begin{equation}
   \input{Fig_PATooDkWFPDooONE.pstricks}
   =
   \input{Fig_PATooDkWFPDooZERO.pstricks}
    \end{equation}
\end{example}
...
\begin{example}
    ...
    \begin{equation}
        3\times \input{Fig_GLVooUSQccDooZERO.pstricks}=\input{Fig_GLVooUSQccDooZERO.pstricks}+\input{Fig_GLVooUSQccDooZERO.pstricks}+\input{Fig_GLVooUSQccDooZERO.pstricks}=\input{Fig_GLVooUSQccDooONE.pstricks}+\input{Fig_GLVooUSQccDooZERO.pstricks}.
    \end{equation}
