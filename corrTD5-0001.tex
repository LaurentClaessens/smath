...
\begin{corrige}{TD5-0001}
	...
	\begin{enumerate}
		...
		\item
			...
			\end{equation}
		\item
            % TODO : voir comment fonctionne cette figure.
			...
			\end{equation}
			%En regardant la figure \ref{LabelFigUnSurxInt}, 
            %TODO : décommenter cette ligne après avoir fait le todo précédent.
            Sur un dessin nous voyons que les aires à gauche sont les mêmes que les aires à droite, sauf que le signe change. Nous pouvons donc écrire
			\begin{equation}
