...
% ATTENTION : lorsqu'on compile avec lst_ds*.py, les versionexo2smath-0246s plus grandes sont à vérifier.
...
% Il faut anticiper la question de la calculatrice
% Pour les 4A, il faudra une question graphique sur la proportionnalité
