...
\begin{enumerate}
    \item
        Rechercher, extraire et organiser l'information utile : \ref{exo2smath-0163}.
    ...
    \item
        ...
        % reprérer les angles 'qui vont ensemble'
    \item 
        Présenter la démarche suivie, les résultats obtenus, communiquer à l'aide d’un langage adapté : \ref{exo2smath-0156}\ref{ItemCUFLooIdJOVd}, \ref{exo2smath-0163}.
\end{enumerate}
\end{feuilleDS}
