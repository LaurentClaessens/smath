...
\begin{example}
    ...
    \begin{enumerate}
        \item
            ...
            \begin{equation}
                \frac{ 1\times 4 }{ 3\times 4 }+\frac{ 5 }{ 12 }
            \end{equation}
        \item
        ...
        \item
            ...
            \begin{equation}
                A=\frac{ 9 }{ 12 }=\frac{ 9\div 3 }{ 12\div 3 }=\frac{ 3 }{ 4 }.
            \end{equation}
    \end{enumerate}
\end{example}
...
% Il faut revoir cette activité de telle sorte que les deux façons de calculer soient proposées par les élèves.
