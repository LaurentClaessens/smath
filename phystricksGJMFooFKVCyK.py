...
def GJMFooFKVCyK():
    ...
    measureAE.put_mark(0.2,angle=None,added_angle=0,text="\( 2\)",automatic_place=(pspict,""))

    measureEF=MeasureLength(Segment(cube.E,cube.F),-0.1)
    measureEF.put_mark(0.2,angle=None,added_angle=0,text="\( 3\)",automatic_place=(pspict,""))

    measureAD=MeasureLength(Segment(cube.A,cube.D),0.1)
    measureAD.put_mark(0.2,angle=None,added_angle=0,text="\( 1\)",automatic_place=(pspict,""))
