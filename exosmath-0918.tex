...
\begin{exercice}\label{exosmath-0918}
    ...
    \begin{multicols}{2}
        \begin{enumerate}
            \item
                \input{Fig_LVNXooEXEvoVZ.pstricks}
            \item
                \input{Fig_LVNXooEXEvoVO.pstricks}
            \item
                \input{Fig_LVNXooEXEvoVT.pstricks}
            \item
                \input{Fig_LVNXooEXEvoVTh.pstricks}
            \item
                \input{Fig_LVNXooEXEvoVF.pstricks}
        \end{enumerate}
    \end{multicols}
