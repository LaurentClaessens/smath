...
\begin{exercice}\label{exosmath-0918}
    ...
    \begin{multicols}{2}
        \begin{enumerate}
            \item
                \input{Fig_LVNXooEXEvoV0.pstricks}
            \item
                \input{Fig_LVNXooEXEvoV1.pstricks}
            \item
                \input{Fig_LVNXooEXEvoV2.pstricks}
            \item
                \input{Fig_LVNXooEXEvoV3.pstricks}
            \item
                \input{Fig_LVNXooEXEvoV4.pstricks}
        \end{enumerate}
    \end{multicols}
