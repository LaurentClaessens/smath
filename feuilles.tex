...
% INTERRO NUMÉRO 6 POUR 4A (VENDREDI 17 AVRIL) : COSINUS ET EXPRESSIONS LITTÉRALES.
\begin{document}
\multiinput{interro_16}{2} % interro_4A6
\end{document}


% SALLE MULTIMEDIA vendredi 24 AVRIL 2015
% Lorsque c'est fait, il faudra mettre dans 24_autrecinquieme et le correspondant pour la quatrième
\begin{document}

\multiinput{multimed5ABavril.tex}{2}

\clearpage

\multiinput{multimed4Aavril.tex}{2}


\vspace{0.5cm}
\tiny
Note pour moi : une équation possible comme extension est : \( 4x+5=2x-259\).
...
% IMPRESSION CHAPITRE NOMBRES RELATIFS : OPÉRATIONS (5A)
\begin{document}
\multiinput{activ_carte_rel}{4}
\end{document}


% MINI INTERRO NUMÉRO 5 POUR 5A : angles-parall et proportionnalité (10 avril 2015)
% MINI INTERRO NUMÉRO 5 POUR 5B : angles-parall et exp litt (vendredi 10 avril 2015)
% les deux dans le même document.
\begin{document}
\multiinput{interro_14}{2}  % 5A
\clearpage
\multiinput{interro_15}{2}  % 5B
\end{document}

% IMPRESSION CHAPITRE PYRAMIDES (4A)
\begin{document}
\multiinput{activ_araign_pyramide}{2}
\clearpage
\multiinput{activ_cone}{3}
\clearpage
\multiinput{activ_volume_pyr}{3}
\end{document}


% DEUXIÈME FEUILLE DE SECOURS, CINQUIÉME
\begin{document}
\begin{center}
    Feuille de secours numéro 2
\end{center}
...
% IMPRESSION CHAPITRE PROPORTIONNALITÉ (5B)
\begin{document}
\multiinput{activ_propo}{4}
\newpage
\multiinput{activ_encore_confitures2}{5}
\newpage
\multiinput{activ_melange2}{5}
\end{document}


% CHAPITRE PUISSANCE (QUATRIÈME)
\begin{document}
\newcommand{\CaptionFigMOCGooKjSrVV}{Quelque triangles de Sierpiński}
\multiinput{activ_trig_Sierpinski}{2}
\clearpage
\multiinput{activ_puiss_neg}{8}
\end{document}
...
\input{Fig_QTCQooFtDgwk.pstricks}
\newpage
\input{Fig_QZPMooIiOQpyZ.pstricks}
\input{Fig_QZPMooIiOQpyZ.pstricks}
\vspace{1cm}
\input{Fig_QZPMooIiOQpyZ.pstricks}
\input{Fig_QZPMooIiOQpyZ.pstricks}
...
\input{Fig_QZPMooIiOQpyZ.pstricks}
\newpage
\input{Fig_GARYooJCnpFSZ.pstricks}
\input{Fig_GARYooJCnpFSZ.pstricks}
\vspace{1cm}
\input{Fig_GARYooJCnpFSZ.pstricks}
\input{Fig_GARYooJCnpFSZ.pstricks}
