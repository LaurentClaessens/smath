...
from phystricksXABSooLSRHxF import XABSooLSRHxF
...
figures_list=[]
append_picture(KEQLooOrxtCN,1)
append_picture(JRCJooPHFcKn,1)
append_picture(SKZKooYWRnFD,1)
append_picture(VectoParallItzteT,1)
append_picture(figureNNgEEzx,1)
append_picture(VectoParallelgjDlmD,1)
append_picture(FSSAooLvkqAf,1)
append_picture(VATIooEwQldd,1)
append_picture(JYAKooXjBUpt,1)
append_picture(DWHNooSCJJNE,1)
append_picture(UFBQooOXIMjV,1)
append_picture(VFJVooUXwMvM,1)
append_picture(YBWRooQjwZuu,1)
append_picture(HYVFooTHaDDQ,1)
append_picture(YDTGooZGkkei,1)
append_picture(ENQZooVqRaIv,1)
append_picture(UOEOooLxhpSC,1)
append_picture(YMMDooFDCWPN,1)
append_picture(QZABooEsqWaq,1)
append_picture(UZOQooTSAQcl,1)
append_picture(LVNXooEXEvoV,1)
append_picture(FQUNooERdWZY,1)
append_picture(figureTJkpHLv,1)
append_picture(POYHooNCayFj,1)
append_picture(figureDTzvwiz,1)
append_picture(TOcdZDG,1)
append_picture(KREWooIrMfCQ,1)
append_picture(QDPKooICzieh,1)
append_picture(RAACooAwsaVw,1)
append_picture(ZPBMooYYMMgs,1)
append_picture(JJHQooEkspEV,1)
append_picture(LQHOooWPeagY,1)
append_picture(KBOKooTCswpl,1)
append_picture(EvZZys,1)
append_picture(BpCNVm,1)
append_picture(HistoAutomobile,1)
append_picture(HistoTdkccB,1)
append_picture(HistoPySeT,1)
append_picture(HistoAgeFrance,1)
append_picture(HistoAgeKenya,1)
append_picture(EffectifsCumulwfqAhj,1)
append_picture(SurfaceTriangletcNPPE,1)
append_picture(ParabolevQzhjq,1)
append_picture(bDdpfh,1)
append_picture(ParaboleiLbviP,1)
append_picture(ParaboleMCLCbG,1)
append_picture(ParaboleHautMLbPQF,1)
append_picture(ParaboleBasfKtFCN,1)
append_picture(ParabolezBeHFl,1)
append_picture(ParabolezmMGdN,1)
append_picture(ParaboleUneSolPktmCR,1)
append_picture(ParaboleHautjOEAzn,1)
append_picture(ParaboleBasDqAAua,1)
append_picture(ParaboleUniqueHautviflbY,1)
append_picture(ParaboleUniqueBaskGdqda,1)
append_picture(MathCeilwCXIJZ,1)
append_picture(ReperexjVyii,1)
append_picture(PythagoreeBqLDU,1)
append_picture(ParaboleoytUKk,1)
append_picture(ParabolesoDGyNW,1)
append_picture(GrapheAffinHqXJGx,1)
append_picture(ExoIntersectionCourbenzIxXd,1)
append_picture(FCarreQFhsWz,1)
append_picture(ExCarrexvfvre,1)
append_picture(ExResolutionOSiaMS,1)
append_picture(ExEquationIntersectioniSHPTw,1)
append_picture(ExIneqOcAWMq,1)
append_picture(ExIneqfgZWStde,1)
append_picture(ExVariationRXTkoc,1)
append_picture(GrapheVarndvdQM,1)
append_picture(FoncConstFdDkhW,1)
append_picture(GrapheVarREGMqx,1)
append_picture(FnAffineipcEQf,1)
append_picture(MinMaxKNRdOd,1)
append_picture(ParabolesfTKFw,1)
append_picture(CubeLFZuiW,1)
append_picture(DesSectionseVPNeL,1)
append_picture(LectureGraphnrkEEM,1)
append_picture(PasFonctionYoQfSu,1)
append_picture(IllusionNHwEtp,1)
append_picture(LignesCubeshBfjxk,1)
append_picture(FaussePerspectivewAwxAJ,1)
append_picture(CubeLigneTriangleHFMrVU,1)
append_picture(SurfaceCubeXlLEEy,1)
append_picture(DansRectangleGPEkJc,1)
append_picture(PrismeCQlZKY,1)
append_picture(IsoceleVdviOE,1)
append_picture(PerpSegqrbMBZ,1)
append_picture(PositionsDroitesbnYIsH,1)
append_picture(CorSSTXPQVjn,1)
append_picture(GraphInterfQVfSf,1)
append_picture(ParaboleResumeHNiyfR,1)
append_picture(ParaboleResumeSzaWaG,1)
append_picture(FnInterrobgepC,1)
append_picture(RouletteACaVAA,1)
append_picture(PetiteBinomialelzbdWl,1)
append_picture(GrandeBinomialeIyWAIh,1)
append_picture(ExoBinomialeNyQLYI,1)
append_picture(RectanglegHuBZs,1)
append_picture(ThaleszlOKVq,1)
append_picture(DefVecteurAXDDGP,1)
append_picture(ChaslesGTRtKR,1)
append_picture(VectoMilieuNuWgHW,1)
append_picture(ExoVectoFRPXxB,1)
append_picture(ExoVectoPJGrRF,1)
append_picture(ExoTrigTrIpPW,1)
append_picture(PositionRelativexpwkEJ,1)
append_picture(PositionPlansTvKvah,1)
append_picture(PositionPlansqSltxa,1)
append_picture(figureBCtCTZo,1)
append_picture(figureASkECWS,1)
append_picture(figureCSIQETx,1)
append_picture(figureTFaRFVd,1)
append_picture(figureERITfSy,1)
append_picture(figureNPQwFTp,1)
append_picture(figureITVTofz,1)
append_picture(figureNAKnjxQ,1)
append_picture(figureWFDTzSN,1)
append_picture(JOKJMTD,1)
append_picture(figureYWEhCkv,1)
append_picture(figureAEcZqpP,1)
append_picture(ExoTranslationPNjoHk,1)
append_picture(figureKHUxoaG,1)
append_picture(figureXQZwoWu,1)
append_picture(CylindresxKDOdy,1)
append_picture(figureFNkqWFE,1)
append_picture(figureLEOvqez,1)
append_picture(figureVNaHvXi,1)
append_picture(figureBOuQJyj,1)
append_picture(figureSCkAAJI,1)
append_picture(figureUERGVgS,1)
append_picture(figureQUtOjcm,1)
append_picture(figureXNAufCh,1)
append_picture(figureEWDVDTS,1)
append_picture(figureMYeLqLl,1)
append_picture(figurePQKzIRY,1)
append_picture(figureISQqBVu,1)
append_picture(figureHFdjZpb,1)
append_picture(figureFGgTGJA,1)
append_picture(KKEdcAR,1)
append_picture(figureXCScSiP,1)
append_picture(figureSZyxsvp,1)
append_picture(figureHYeBZVj,1)
append_picture(figureKAzSlQr,1)
append_picture(figureEHyIMRQ,1)
append_picture(figureSIZwqIZ,1)
append_picture(figureMIdFCNN,1)
append_picture(figureZEKOYck,1)
append_picture(figureSNpNWPt,1)
append_picture(figureCFoZCYe,1)
append_picture(figureWYxZPMW,1)
append_picture(YAaXJqQ,1)
append_picture(VMNerGf,1)
append_picture(YORfWSM,1)
append_picture(LOBVHYF,1)
append_picture(BIlgjwy,1)
append_picture(JHrkjFz,1)
append_picture(GCxOEgb,1)
append_picture(JRVlexw,1)
append_picture(YVZAXhU,1)
append_picture(IQnEPpt,1)
append_picture(XSMDwcv,1)
append_picture(ITZAPPh,1)
append_picture(KQluTdN,1)
append_picture(IXtyOnk,1)
append_picture(FLnDVHh,1)
append_picture(CZAVGrm,1)
append_picture(OIHVjmO,1)
append_picture(OSQOqJN,1)
append_picture(BZqEWco,1)
append_picture(AVFexUi,1)
append_picture(LSaSLoS,1)
append_picture(VDqUhPV,1)
append_picture(KMJQWwa,1)
append_picture(ITlywMb,1)
append_picture(EGDFJAT,1)
append_picture(AHAbqhj,1)
append_picture(WRXbDCo,1)
append_picture(GRRhrJe,1)
append_picture(AZKoIsL,1)
append_picture(OWGRRSC,1)
append_picture(ZQfGNsD,1)
append_picture(IRHrmQQ,1)
append_picture(KGOAveW,1)
append_picture(PXsdjSu,1)
append_picture(XPqLRCF,1)
append_picture(MEzTDZC,1)
append_picture(ONMRllE,1)
append_picture(IDqyzXM,1)
append_picture(ETfnbsh,1)
append_picture(ENQhxmG,1)
append_picture(YRQOoPE,1)
append_picture(KDtwIJf,1)
append_picture(MAXkaGz,1)
append_picture(LTenBUj,1)
append_picture(ALzPUfm,1)
append_picture(LQGzkvL,1)
append_picture(APYEkIv,1)
append_picture(UKBImJl,1)
append_picture(MUriGyU,1)
append_picture(WGhpCVm,1)
append_picture(HMNXfhy,1)
append_picture(PYYEasw,1)
append_picture(DNYAefI,1)
append_picture(FWyrYhJ,1)
append_picture(YGlrtNX,1)
append_picture(EDnzyzS,1)
append_picture(BZRzIsR,1)
append_picture(VXFxyni,1)
append_picture(YBxSjFS,1)
append_picture(ITzxISE,1)
append_picture(RLGQTQR,1)
append_picture(WYeESAN,1)
append_picture(EIxhcRb,1)
append_picture(JXWXdJI,1)
append_picture(PUGmLBC,1)
append_picture(LZDNqtV,1)
append_picture(APNeGtp,1)
append_picture(QLbEnnx,1)
append_picture(JLUTBlD,1)
append_picture(FFyFBoe,1)
append_picture(RRlBSZg,1)
append_picture(GSfDCyx,1)
append_picture(EJbcoxO,1)
append_picture(ILauamX,1)
append_picture(WPrirwB,1)
append_picture(OZfyDkr,1)
append_picture(KYbSnVB,1)
append_picture(AILoxBg,1)
append_picture(XDdastq,1)
append_picture(GTyQVvw,1)
append_picture(RZwXiJD,1)
append_picture(RHfkPKj,1)
append_picture(WTVlzUE,1)
append_picture(XMjsBcU,1)
append_picture(UZlaYZ,1)
append_picture(OKeZlpK,1)
append_picture(RVZNtGK,1)
append_picture(CFFyezr,1)
append_picture(QGRiHbb,1)
append_picture(DDRbyQk,1)
append_picture(SWFywZG,1)
append_picture(ZMGMLvNBa,1)
append_picture(NIGYQHN,1)
append_picture(OCFmVDE,1)
append_picture(CFjmTFb,1)
append_picture(GUEjmmR,1)
append_picture(IBmsroy,1)
append_picture(OLuvnaY,1)
append_picture(QFpJtQc,1)
append_picture(QGaeERu,1)
append_picture(GJbvyTt,1)
append_picture(TCpyyhO,1)
append_picture(YMslVxg,1)
append_picture(JLrRNbT,1)
append_picture(SUCoowlFdp,1)
append_picture(VGQoojvDGr,1)
append_picture(HYKooCotyT,1)
append_picture(NUWooJepuh,1)
append_picture(MJZoobAMRb,1)
append_picture(MTZooSGviQ,1)
append_picture(TAIooroZRs,1)
append_picture(IERooEvNjp,1)
append_picture(LXWooEsxsx,1)
append_picture(RWZooOBMHZ,1)
append_picture(MVHooAdkhKq,1)
append_picture(TQDooEgJgPZ,1)
append_picture(JSFooDBSHFo,1)
append_picture(STSooGUprbS,1)
append_picture(DPXooCqCUDl,1)
append_picture(SZYooRuSplc,1)
append_picture(VFAooZmuvtW,1)
append_picture(WGCXlvC,1)
append_picture(TWGooMalxLa,1)
append_picture(LCUooNGZJFk,1)
append_picture(KXXooKBoqAY,1)
append_picture(SurfacesCubesclGZD,1)
append_picture(SWHooJzpmlM,1)
append_picture(RYDooDLpToB,1)
append_picture(IPAooQliVZD,1)
append_picture(UKTooJhUzKU,1)
append_picture(CKOooBQtves,1)
append_picture(TJDooMNBjjK,1)
append_picture(NOPooYlqjzW,1)
append_picture(HVXooRtjPkd,1)
append_picture(OJDooPOzSiC,1)
append_picture(RKSooSVlhiF,1)
append_picture(TOIooUindpy,1)
append_picture(EISooBQSffk,1)
append_picture(IIHooSeavps,1)
append_picture(SAZooPjiyOV,1)
append_picture(PATooDkWFPD,1)
append_picture(JTQooDUZpht,1)
append_picture(NARooFiHuAy,1)
append_picture(NWPooWQBSnz,1)
append_picture(LRWooCalQsT,1)
append_picture(LXQooZPbZml,1)
append_picture(MFWooBwnCkX,1)
append_picture(CNTooDFQFEQ,1)
append_picture(PSZooRphUET,1)
append_picture(CVKooPKKMNG,1)
append_picture(JJGooMMFWLs,1)
append_picture(CMOooKlzoBL,1)
append_picture(CXWooOMPOQT,1)
append_picture(TYIooYKqeNv,1)
append_picture(MBTooHyyNvj,1)
append_picture(AKLooNbKioN,1)
append_picture(GLVooNqioTo,1)
append_picture(FDOooRCCWGn,1)
append_picture(KUUooRcCjkQ,1)
append_picture(UEqUrvi,1)
append_picture(DZmbmzZ,1)
append_picture(YDAooMNHhCN,1)
append_picture(GVGooXlzMMh,1)
append_picture(RBEooLYHhMX,1)
append_picture(XYXooNdhQer,1)
append_picture(KSQooHHfEpe,1)
append_picture(BKWooKbAHbD,1)
append_picture(UPGooXSYGqo,1)
append_picture(QAHooOhyyHI,1)
append_picture(IUHooFrAHoa,1)
append_picture(GLVooUSQccD,1)
append_picture(YEWSooDXYRJo,1)
append_picture(TCBLooKXvOaZ,1)
append_picture(YAFJooWuUmHJ,1)
append_picture(MRBWooRCSkaB,1)
append_picture(GARYooJCnpFS,1)
append_picture(QZPMooIiOQpy,1)
append_picture(AWKEooFytNYo,1)
append_picture(PMVPooKtUXux,1)
append_picture(DTFZooTlciUT,1)
append_picture(XSTKooZqTACG,1)
append_picture(MITEooHPaqZu,1)
append_picture(RRLOooSCZSre,1)
append_picture(HHRTooMDylcn,1)
append_picture(KSLDooMnmoPU,1)
append_picture(ZFNXooSjzTPJ,1)
append_picture(MEWYooRvygNF,1)
append_picture(ARKZooKZOuAk,1)
append_picture(QTCQooFtDgwk,1)
append_picture(VJZKooGlvyPP,1)
append_picture(SVPCooGYtlqq,1)
append_picture(VUOCooYkrktO,1)
append_picture(QLQYooNbqiXG,1)
append_picture(XCWLooVgowie,1)
append_picture(JQFHooEDhWVO,1)
append_picture(FIOJooSmlhXR,1)
append_picture(XUBNooNxZEmS,1)
append_picture(MEAQooWoXbHZ,1)
append_picture(DSBHooZdaNyy,1)
append_picture(TFUFooJKyBhZ,1)
append_picture(JAQHooIhMeKp,1)
append_picture(YMGAooVCIBvE,1)
append_picture(CFWIooWDSwRD,1)
append_picture(NGWKooMCeSDk,1)
append_picture(TBHUooKbohnF,1)
append_picture(IRQOooJMDFdv,1)
append_picture(KPWWooFyZHHV,1)
append_picture(NWVMooKshXYo,1)
append_picture(RNTRooAXhubs,1)
append_picture(DIPLooHILUUs,1)
append_picture(OQTDooZHOnob,1)
append_picture(XFMTooSCJlTh,1)
append_picture(UKRHooEvocBg,1)
append_picture(AIHBooJaRFHA,1)
append_picture(OBLUooWYQnuB,1)
append_picture(PJUIooZuEnPk,1)
append_picture(NPGPooUwaiww,1)
append_picture(MXHCooEnhHYe,1)
append_picture(TJPGooLVSxKK,1)
append_picture(QEMNooDcNLFy,1)
append_picture(CZFJooUDaKCj,1)
append_picture(JSRHooOdlPDT,1)
append_picture(PJMMooDNBRCx,1)
append_picture(ZMSWooTAPggA,1)
append_picture(QTGHooGVusrk,1)
append_picture(QBDMooGskfKN,1)
append_picture(OPZVooLOyZWh,1)
append_picture(IQKJooUmvFBs,1)
append_picture(OHDIooDdupWC,1)
append_picture(UDKYooKlVbjh,1)
append_picture(LZKGooYGQxGy,1)
append_picture(BJPOooZTVHhi,1)
append_picture(UCAOooLGwJUe,1)
append_picture(EZTHooBttIaQ,1)
append_picture(MLZLooYDRsFl,1)
append_picture(ANRUooVCOTOb,1)
append_picture(PQYKooJWKpVZ,1)
append_picture(ZRDYooCERmeJ,1)
append_picture(JMQIooOMgNvh,1)
append_picture(FLXBooMvWhiY,1)
append_picture(RYNYooMFTMNR,1)
append_picture(SVPAooIuxHvP,1)
append_picture(SHSRooHgvofo,1)
append_picture(GDSEooVtgtKw,1)
append_picture(RGRLooTmnwQZ,1)
append_picture(HWLHooGuSDwM,1)
append_picture(NAEFooZfyhCs,1)
append_picture(DIDMooOJHGra,1)
append_picture(GLKFooKwvxSl,1)
append_picture(VUUBooRqdACk,1)
append_picture(SYKMooKLBCXR,1)
append_picture(GVPPooOpnIyt,1)
append_picture(QXYWooOWHshl,1)
append_picture(GQVWooMiTJnC,1)
append_picture(YEGUooNJuuDC,1)
append_picture(OGWJooWdCsvT,1)
append_picture(CRKLooLhpFTy,1)
append_picture(CMUTooFyLisx,1)
append_picture(KUMFooSHPFkG,1)
append_picture(YIGPooZbaCAI,1)
append_picture(GSPNooCOfCGS,1)
append_picture(KQGKooQyKvWm,1)
append_picture(VGVIooUoZpRA,1)
append_picture(KRCFooOBTdqV,1)
append_picture(GCFSooTCJfOZ,1)
append_picture(NXOIooIIWUmq,1)
append_picture(GRBOooIZYhIV,1)
append_picture(RKXHooRkoXOP,1)
append_picture(TVRGooTuCNyN,1)
append_picture(FBTCooBKTryQ,1)
append_picture(VXUCooAxCIuP,1)
append_picture(JFYIooGELsSX,1)
append_picture(UMQMooOlJYbZ,1)
append_picture(NUEGooGTqxcl,1)
append_picture(ZZPQooStuRcw,1)
append_picture(GHKHooEnlVFf,1)
append_picture(NQWWooIaAkTf,1)
append_picture(HXDOooHsfhus,1)
append_picture(SRYNooEdaMMH,1)
append_picture(VXDJooBGRpbL,1)
append_picture(BAHMooAGUdjV,1)
append_picture(FTKEooCLvbNp,1)
append_picture(LLBQooAjaorQ,1)
append_picture(ZUVLooJNWbPB,1)
append_picture(TFDNooJemFMW,1)
append_picture(GRUUooPtPBqp,1)
append_picture(HTGDooAVOWgZ,1)
append_picture(CYLGooSGnRii,1)
append_picture(LOPLooZJmTuk,1)
append_picture(ZUZXooIFCxcB,1)
append_picture(NFCHooAFFYPx,1)
append_picture(WUEUooYWwanB,1)
append_picture(IDKXooPrOOeE,1)
append_picture(WIYOooLoAtKD,1)
append_picture(MWIPooDUJRIo,1)
append_picture(KYVAooVmGYhS,1)
append_picture(FSQMooFDOrkR,1)
append_picture(PIMUooMLLYDU,1)
append_picture(HRIVooBXxZES,1)
append_picture(MWFBooZHANAt,1)
append_picture(LNQRooVNAJpf,1)
append_picture(FARZooXFSDav,1)
append_picture(TLEXooPDNwLR,1)
append_picture(MOCGooKjSrVV,1)
append_picture(IJFGooPLxXAV,1)
append_picture(SBRXooGUNvLA,1)
append_picture(QJGGooLkuRLI,1)
append_picture(JSYRooLLggNJ,1)
append_picture(PYSIooVNiiuo,1)
append_picture(NHGWooBOAkGS,1)
append_picture(OVATooYCMzBB,1)
append_picture(PPZRooTpQJOC,1)
append_picture(SCUKooLMEReM,1)
append_picture(QCARooMunXfF,1)
append_picture(MXGVooOFDqLq,1)
append_picture(MXXQooRUNiwK,1)
append_picture(VUXBooJLuLUk,1)
append_picture(ZJATooXEJmyI,1)
append_picture(SXKLooPzFTnQ,1)
append_picture(KJWQooEicWkQ,1)
append_picture(CXDBooJMfhRr,1)
append_picture(UVWMooNNnbbG,1)
append_picture(GJMFooFKVCyK,1)
append_picture(YLPFooXzdaFr,1)
append_picture(XABSooLSRHxF,1)   # Crée les figures PDNJooMoHgCM et EIHJooJrGgmN
append_picture(SWYDooBCeFJb,1)
append_picture(XTGXooDVcEZs,1)
append_picture(ZSAooVHmHWd,1)        # Une seule des deux figures est utilisée
append_picture(CSFRooVynjkf,1)
append_picture(LWKNooOqJykO,1)
append_picture(DEAXooTRICJi,1)
append_picture(EABWooPkLqOJ,1)
append_picture(UTDOooJFkZWu,1)
append_picture(ZQRZooGsxVIr,1)
append_picture(RRWJooIPQhTn,1)
append_picture(RMYEooXvicms,1)
append_picture(AAQGooENsxae,1)
append_picture(AMXQooFiUqRS,1)
append_picture(DNWGooZENzno,1)
append_picture(BODTooGUhQDy,1)
append_picture(XVMLooOHswig,1)
append_picture(XUATooMWfESC,1)
append_picture(FDOMooPmHEcu,1)
append_picture(LOGZooNgDIkE,1)
append_picture(ZBHLooYfpkZA,1)
append_picture(IKZEooAwkZSy,1)
append_picture(BXFFooNyvPYY,1)
append_picture(MXGJooGTXbPw,1)
append_picture(LVALooSubNDJ,1)
append_picture(JHVRooIEVJMg,1)
append_picture(HMUTooSSSCZl,1)
append_picture(CBHVooIgPuTm,1)
append_picture(GOARooHSKUuw,1)
append_picture(VEDYooDMnRha,1)
append_picture(KUZZooNuCtFc,1)
append_picture(XKZSooPNxqjW,1)
append_picture(OAHLooOwLezW,1)
append_picture(KTEDooQRUWXz,1)
append_picture(WHWXooTAHTOd,1)
append_picture(ELFXooRwIoJO,1)
append_picture(SMXRooCnrlNw,1)
append_picture(LIWGooNsyZBz,1)
append_picture(EDEYRhQ,1)
append_picture(OZXooCVkgQ,1)
append_picture(OTGooGcktOd,1)
append_picture(VNJWooDeKdcy,1)
append_picture(HUGKooTkDsOg,1)
append_picture(LWNSooVGvWxJ,1)
append_picture(HHOooQUedri,1)
append_picture(CBLooYAMumJ,1)
append_picture(FJPooMGmakN,1)
append_picture(IFTGooWtjCeQ,1)
append_picture(SLULooXaUibV,1)
append_picture(SimulBinNWxfTN,1)     # Vu qu'il y a de l'aléatoire, le fichier intermédiaire fait toujours un Warning
append_picture(ExoGraphIneqPgErDr,1)
append_picture(ECQDooWEpuCM,1)
append_picture(VAAYooXndWQq,1)
append_picture(QEPZooNndwiS,1)
append_picture(KNPRooNdvKmg,1)
append_picture(JJQWooIxyPzf,1)
append_picture(VRQCooOchjJA,1)
"""
append_picture(<++>,1)
append_picture(<++>,1)
append_picture(<++>,1)
