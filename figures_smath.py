...
figures_list.append(QEPZooNndwiS)
figures_list.append(GRUUooPtPBqp)
figures_list.append(HTGDooAVOWgZ)
figures_list.append(CYLGooSGnRii)
figures_list.append(LOPLooZJmTuk)
figures_list.append(ZUZXooIFCxcB)
figures_list.append(NFCHooAFFYPx)
figures_list.append(WUEUooYWwanB)
figures_list.append(IDKXooPrOOeE)
figures_list.append(WIYOooLoAtKD)
figures_list.append(MWIPooDUJRIo)
figures_list.append(KYVAooVmGYhS)
figures_list.append(FSQMooFDOrkR)
figures_list.append(PIMUooMLLYDU)
figures_list.append(HRIVooBXxZES)
figures_list.append(MWFBooZHANAt)
figures_list.append(LNQRooVNAJpf)
figures_list.append(FARZooXFSDav)
figures_list.append(TLEXooPDNwLR)
figures_list.append(MOCGooKjSrVV)
figures_list.append(IJFGooPLxXAV)
figures_list.append(SBRXooGUNvLA)
figures_list.append(QJGGooLkuRLI)
figures_list.append(JSYRooLLggNJ)
figures_list.append(PYSIooVNiiuo)
figures_list.append(NHGWooBOAkGS)
figures_list.append(OVATooYCMzBB)
figures_list.append(PPZRooTpQJOC)
...
figures_list.append(CXDBooJMfhRr)
...
figures_list.append(AAQGooENsxae)
figures_list.append(AMXQooFiUqRS)
figures_list.append(DNWGooZENzno)
figures_list.append(BODTooGUhQDy)
figures_list.append(XVMLooOHswig)
figures_list.append(XUATooMWfESC)
figures_list.append(FDOMooPmHEcu)
figures_list.append(LOGZooNgDIkE)
figures_list.append(ZBHLooYfpkZA)
figures_list.append(IKZEooAwkZSy)
figures_list.append(BXFFooNyvPYY)
figures_list.append(MXGJooGTXbPw)
figures_list.append(UFBQooOXIMjV)
figures_list.append(DWHNooSCJJNE)
figures_list.append(JYAKooXjBUpt)
figures_list.append(POYHooNCayFj)
figures_list.append(LVALooSubNDJ)
figures_list.append(JHVRooIEVJMg)
figures_list.append(VATIooEwQldd)
figures_list.append(HMUTooSSSCZl)
figures_list.append(CBHVooIgPuTm)
figures_list.append(FSSAooLvkqAf)
figures_list.append(GOARooHSKUuw)
figures_list.append(VEDYooDMnRha)
figures_list.append(KUZZooNuCtFc)
figures_list.append(XKZSooPNxqjW)
figures_list.append(OAHLooOwLezW)
figures_list.append(KTEDooQRUWXz)
figures_list.append(WHWXooTAHTOd)
figures_list.append(ELFXooRwIoJO)
figures_list.append(SMXRooCnrlNw)
figures_list.append(LIWGooNsyZBz)
