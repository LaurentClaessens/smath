...
\begin{MentalActivity}
   ...
   \input{Fig_RYDooDLpToB.pstricks}
    ...
    \begin{mental}
        \begin{enumerate}
            \item
                $\unit{250}{\centi\meter}=\unit{\ldots}{\meter}$
            \item
                $\unit{1}{\liter}=\unit{\ldots}{\deci\cubic\meter}$
            \item
                \( \unit{1}{\hour}=\unit{\ldots}{\second}\)
        \end{enumerate}
    \end{mental}
...
\begin{MentalActivity}
    ...
    \begin{mental}
        ...
        \begin{subequations}
            \begin{align}
                AB&=\unit{5}{\centi\meter}\\
                BC&=\unit{\ldots}{\centi\meter}\\
                AC&=\unit{4}{\centi\meter}
            \end{align}
        \end{subequations}
    \end{mental}
    <++>
