...
\begin{MentalActivity}          
\input{mentaltruc-0001}
\input{mentaltruc-0002}         % Symétrie centrale
\input{mentaltruc-0003}
\input{mentaltruc-0004}         % Compléter avec l'entier le plus proche
\end{MentalActivity}
...
\input{mentaltruc-0017}   %tableau de proportionnalité
\input{mentaltruc-0021}
\end{MentalActivity}

% Pour le 10 avril
\begin{MentalActivity}
\input{mentaltruc-0027}
\input{mentaltruc-0020}
\input{mentaltruc-0019}
\end{MentalActivity}

% Pour le 22 mai
\begin{MentalActivity}
\input{mentaltruc-0047}
\input{mentaltruc-0048}
\input{mentaltruc-0042}
\end{MentalActivity}

% Pour le 5 juin
\begin{MentalActivity}
\input{mentaltruc-0059}
\input{mentaltruc-0062}
\input{mentaltruc-0064}
\end{MentalActivity}

% Pour le 19 juin
\begin{MentalActivity}
\input{mentaltruc-0067}
\input{mentaltruc-0056}
\input{mentaltruc-0069}
\end{MentalActivity}<++>
...
\begin{MentalActivity}  
\input{mentaltruc-0009}
\input{mentaltruc-0010}
\input{mentaltruc-0011}
\end{MentalActivity}

% Pour 5B 20 mars 2015
\begin{MentalActivity}  
\input{mentaltruc-0005}   % somme des angles plat fait 180
\input{mentaltruc-0016}     % Symétrie centrale
\input{mentaltruc-0020}
\end{MentalActivity}  

% Déjà fait
\begin{MentalActivity}
\input{mentaltruc-0018}
\input{mentaltruc-0028}
\input{mentaltruc-0029}
\end{MentalActivity}

% Pour le 10 avril
\begin{MentalActivity}
\input{mentaltruc-0033}
\input{mentaltruc-0034}
\input{mentaltruc-0035}
\end{MentalActivity}
...
% Pour le 29 mai
\begin{MentalActivity}
\input{mentaltruc-0053}
\input{mentaltruc-0054}
\input{mentaltruc-0055}
\end{MentalActivity}
...
\begin{MentalActivity}
\input{mentaltruc-0065}  %équation
\input{mentaltruc-0039}
\input{mentaltruc-0058}
\input{mentaltruc-0060}
\input{mentaltruc-0061}
\input{mentaltruc-0062} % Fait avec 5A
\input{mentaltruc-0064}  % Fait 5A
\end{MentalActivity}
