...
def BXFFooNyvPYY():
    ...
    mediane=Segment(A,K)
    K.put_mark(0.3,angle=None,added_angle=0,text="\( K\)",pspict=pspict)

    trig.edges[0].put_mark(0.2,angle=None,added_angle=0,text="\SI{3}{\centi\meter}",pspict=pspict)
    trig.edges[2].put_mark(0.2,angle=None,added_angle=0,text="\SI{8}{\centi\meter}",pspict=pspict)
