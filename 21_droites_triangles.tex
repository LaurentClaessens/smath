...
\begin{center}
   \input{Fig_QZPMooIiOQpyooZERO.pstricks}\hfill
   \input{Fig_QZPMooIiOQpyooONE.pstricks}
\end{center}
...
\begin{center}
\input{Fig_GARYooJCnpFSooZERO.pstricks}\hfill
\input{Fig_GARYooJCnpFSooONE.pstricks}
\end{center}

\begin{propriete}
    Une médiane partage un triangle en deux parties de même aire.
\end{propriete}
...
\end{center}
Les triangles \( AMC\) et \( BMC\) ont même aire.
