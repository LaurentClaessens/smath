...
\begin{Aretenir}
    ...
    \begin{enumerate}
        ...
        \item
            Si les points \( A\), \( B\) et \( C\) du plan sont donnés, la perpendiculaire à \( (AB)\) passant par \( C\).
        \item
            Si les points \( A\), \( B\) et \( C\) du plan sont donnés, la parallèle à \( (AB)\) passant par \( C\).
    \end{enumerate}
\end{Aretenir}
