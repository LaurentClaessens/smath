...
def JJHQooEkspEV():
    ...
    M.put_mark(0.5,M.advised_mark_angle(pspicts)+180,"\( M\)",pspicts=pspicts,position="corner")
    O=triangle.edges[0].midpoint()
    O.put_mark(0.5,O.advised_mark_angle(pspicts)+180,"\( O\)",pspicts=pspicts,position="corner")
