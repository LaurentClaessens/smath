...
def ELFXooRwIoJO():
    ...
    for ba in [(A,"A"),(B,"B"),(C,"C")]:
        ...
        pt.put_mark(0.2,angle=-90,added_angle=0,text=mathize(nom),automatic_place=(pspict,""))
        ptp.put_mark(0.2,angle=None,added_angle=0,text=mathize(nom+"'"),automatic_place=(pspict,""))
        seg=Segment(pt,ptp)
