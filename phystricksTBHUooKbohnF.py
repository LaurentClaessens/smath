...
def TBHUooKbohnF():
    ...
    I.put_mark(0.2,I.advised_mark_angle(pspicts)+180,"\( I\)",automatic_place=(pspicts,"corner"))
    J.put_mark(0.2,J.advised_mark_angle(pspicts)+180,"\( J\)",automatic_place=(pspicts,"corner"))
    K.put_mark(0.2,K.advised_mark_angle(pspicts)+180,"\( K\)",automatic_place=(pspicts,"corner"))
