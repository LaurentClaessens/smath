...
def WGCXlvC():
    ...
    F[0].put_mark(0.2,180,"\( d_1\)",mark_point=F[0].I,pspict=pspict,position="N")
    F[1].put_mark(0.2,0,"\( d_2\)",mark_point=F[1].F,pspict=pspict,position="W")
    F[2].put_mark(0.2,0,"\( d_3\)",mark_point=F[2].F,pspict=pspict,position="W")
    F[3].put_mark(0.2,180,"\( d_4\)",mark_point=F[3].I,pspict=pspict,position="N")
