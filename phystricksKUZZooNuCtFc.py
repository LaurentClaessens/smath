...
def KUZZooNuCtFc():
    ...
    L.put_mark(0.2,angle=None,added_angle=0,text="\( L\)",automatic_place=(pspict,""))
    ...
    #m1=Segment(A,K).get_mark(0.2,angle=None,added_angle=0,text="\SI{7.5}{\milli\meter}",automatic_place=(pspict,""))
    #m2=Segment(L,A).get_mark(0.2,angle=None,added_angle=0,text="\SI{2.3}{\milli\meter}",automatic_place=(pspict,""))
    #m3=Segment(K,L).get_mark(0.2,angle=None,added_angle=0,text="\SI{1,4}{\milli\meter}",automatic_place=(pspict,""))
