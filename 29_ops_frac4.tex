...
\begin{example}
    Baume-les-dames est la moitié du trajet entre Clerval et Besançon. Un tiers du trajet entre Clerval et Besançon représente
    \begin{equation}
        \frac{ 1 }{2}\div 3=\frac{ 1 }{ 6 }
    \end{equation}
    du trajet entre Clerval et Besançon.
