...
\let\second\undefined       % mathabx already defines 'second' and 'degree'
\let\degree\undefined
\usepackage[cdot,thinqspace,amssymb,binary]{SIunits}    %   1410612643
...
% L'importance de la commande \si est que elle existe dans siunitx que j'ai
% un peu utilisé avant d'abandonner.
\newcommand{\SI}[2]{\unit{#1}{#2}}
\newcommand{\si}[1]{#1}
