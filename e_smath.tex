...
\newcommand{\justification}{ {\small \begin{center} Les réponses doivent être justifiées par un calcul et accompagnées d'un raisonnement.\end{center}}}
    ...
    \newenvironment{feuilleDS}[1]{\noindent Nom :\\\noindent Prénom : \begin{center}\large #1\\\justification\end{center}\setcounter{CountExercice}{0}  }{\clearpage}
    \newenvironment{feuilleExos}[1]{\begin{center}\large #1\\\justification\end{center}\setcounter{CountExercice}{0}  }{\clearpage}
