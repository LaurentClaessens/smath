...
\newpage
\begin{example}
    Nous jouons au poker avec des dés. Un dé a \( 6\) face : as, roi, dame, valet, \( 10\), \( 9\). Nous voulons obtenir une paire de valet en lançant trois dés (nous estimons qu'un brelan de valet est une réussite).

    \begin{equation}
    \xymatrix{%
        o&o&o&\fbox{VVV}\\
        o&o&\fbox{VV}\ar[ur]\ar[rd]\\
        o&o&o&\fbox{VV V}\\
        o&\fbox{V}\ar[uur]\ar[ddr]\\
        o&o&o&\fbox{V V V}\\
        o&o&\fbox{V V}\ar[ur]\ar[dr]\\
        o&o&o&\fbox{V VV}\\
        \fbox{\text{Début}}\ar[ruuuu]\ar[rdddd]\\
        o&o&o&\fbox{ V V V}\\
        o&o&\fbox{ V V}\ar[ur]\ar[dr]\\
        o&o&o&\fbox{ V V V}\\
        o&\fbox{ V}\ar[uur]\ar[ddr]\\
        o&o&o&\fbox{ V V V}\\
        o&o&\fbox{xx}\ar[ur]\ar[dr]\\
        o&o&o&\fbox{ V V  V}\\
       }
    \end{equation}
    ...
    Dessiner un arbre, et déterminer la probabilité de réussite.
\end{example}
