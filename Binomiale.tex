...
Pour calculer à la calculatrice \( P(X=k)\) et \( P(X\leq k)\), 
\begin{enumerate}
    \item
        Savoir les paramètres \( n\) et \( p\) de la variable aléatoire \( X\)
    \item
        Sur Casio :
        \begin{enumerate}
            \item
                menu STAT,\fbox{EXE}
            \item
                pour obtenir \( P(X=k)\), DIST BINM Bpd VAR
                pour obtenir \( P(X\leq k)\), DIST BINM Bcd VAR
            \item
                x:\fbox{k}\fbox{EXE}\\
                Numtrial : \fbox{n}\fbox{EXE}\\
                p : \fbox{p}\fbox{EXE}
            \item
                \fbox{EXE}
        \end{enumerate}
    \item
        ...
        \begin{enumerate}
            \item
                distrib DISTRIB
            \item
                pour obtenir \( P(X=k)\), binomFdp(n,p,k),\fbox{enter}\\
                pour obtenir \( P(X\leq k)\), binomFRép(n,p,k),\fbox{enter}
        \end{enumerate}
...
%---------------------------------------------------------------------------------------------------------------------------
\subsection{La formule de la binomiale}
%---------------------------------------------------------------------------------------------------------------------------

% Je rappelle que cette formule n'est pas au programme de première STMG (2012).
...
%---------------------------------------------------------------------------------------------------------------------------
\subsection{Rappels probabilités}
%---------------------------------------------------------------------------------------------------------------------------

\Exo{smath-0096}
\Exo{Premiere-0078}  % Cet exercice est à remettre dans une partie plus générale sur les probas.
