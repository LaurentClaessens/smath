...
La majorité des tableurs comme \wikipedia{fr}{Libreoffice} ou \wikipedia{fr}{Gnumeric}{Gnumeric} possèdent des fonctions toutes faites pour simuler.
...
Le programme suivant est celui écrit par votre serviteur pour produire les résultats et graphiques présentés plus haut.
