...
\begin{definition}
    ...
    \begin{enumerate}
        \item
            Un \defe{parallélogramme}{parallélogramme} est un quadrilatère qui a ses côtés opposés parallèles.
        \item
...
\begin{center}
   \input{Fig_ZUVLooJNWbPBooZERO.pstricks}
\end{center}
    ...
    \begin{center}
        \input{Fig_ZUVLooJNWbPBooONE.pstricks}
    \end{center}
