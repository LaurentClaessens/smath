...
Cette fonction prend en argument une liste \info{A} et un nom \info{nom\_de\_fichier} et crée un fichier tout prêt à être lu par votre tableur. Terminez alors votre programme par la ligne
\begin{quote}
...
Testez aussi ce programme en enlevant le \info{[1:]} à la ligne de la boucle \info{for}.
