...
\begin{enumerate}
    \item
        Une entreprise fait une enquête de satisfaction auprès de \( 500\) de ses clients. Elle obtient \( 350\) réponses satisfaites. Quel est le pourcentage de clients satisfaits ?
    \item
        Son concurrent fait la même enquête et obtient \( 400\) réponses satisfaites, sur \( 650\) personnes sondées. Quelle est l'entreprise qui satisfait le plus ses clients ?
\end{enumerate}
