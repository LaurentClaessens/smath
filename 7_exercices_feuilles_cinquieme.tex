...
%\Exo{2smath-0177}  % Le coup des équerres.
        ...
        % Attention : le coup des équerres demande la réciproque de la propriété des angles alternes-internes. Pour l'instant cette réciproque est dans le chapitre sur les parallélogrammes (32_parallelogramme.tex). Il faut déplacer ce résultat vers ``angles et parallélisme'' pour mettre l'exercice sur les équerres.
