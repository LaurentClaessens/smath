...
%TODO : il me semble que dans les_epaves.tex, il y ait le même paragraphe que celui-ci.

Notre travail sur les coordonnées de vecteurs nous permet de donner une démonstration alternative à la propriété \ref{PropFHznUfJ}.
...
\begin{proof}
    Nous divisons la démonstration en petits pas.
    \begin{subproof}
