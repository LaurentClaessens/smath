...
def VATIooEwQldd():
    ...
    rect.edges[2].put_measure(measure_distance=-0.5,mark_distance=0.2,mark_angle=None,name="\( 3\)",automatic_place=(pspicts,""))
    ...
    trig2.edges[0].put_measure(measure_distance=-0.5,mark_distance=0.2,mark_angle=None,name="\( 5\)",automatic_place=(pspicts,""))
