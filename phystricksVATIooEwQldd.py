...
def VATIooEwQldd():
    ...
    rect.edges[2].put_measure(measure_distance=-0.5,mark_distance=0.2,mark_angle=None,name="\SI{3}{\centi\meter}",pspicts=pspicts)

    trig1=Polygon(A,K,D)
    trig1.put_mark(0.4,points_names=" K ",pspicts=pspicts)
    trig1.edges[2].put_measure(measure_distance=-0.5,mark_distance=0.2,mark_angle=None,name="\SI{7}{\centi\meter}",pspicts=pspicts)
    ...
    trig2.edges[0].put_measure(measure_distance=-0.5,mark_distance=0.2,mark_angle=None,name="\SI{5}{\centi\meter}",pspicts=pspicts)
